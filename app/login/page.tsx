...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[#0F172A] flex items-center justify-center">
      <div className="bg-[#1E293B] border border-[#334155] rounded-xl p-10 w-full max-w-md text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-[#94A3B8] mt-2 text-sm">The Financial Brain for Agentic Commerce</p>
        </div>
        <Button
        ...
        <p className="text-xs text-[#94A3B8]">
          Demo app — use any Google account
        </p>
      </div>
    </div>
  );
